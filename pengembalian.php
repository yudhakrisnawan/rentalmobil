...
<!--Header-part-->
<div id="header">
  <h1><a href="pengembalian.php">Pengembalian</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="pengembalian.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>Pengembalian</span></a>
  <ul>
  <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li class="active"> <a href="pengembalian.php"><i class="icon icon-inbox"></i> <span>Pengembalian</span></a> </li>
  ...
  ?>
    <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="data_mobil_admin.php"><i class="icon icon-tasks"></i> <span>Data Mobil</span></a> </li>
    <li> <a href="data_transaksi.php"><i class="icon icon-inbox"></i> <span>Data Transaksi</span></a> </li>
    <li> <a href="logout.php"><i class="icon icon-sign-out"></i> <span>Logout</span></a> </li>
  <?php
    }
  ?>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="pengembalian.php" title="Go to here" class="tip-bottom"><i class="icon icon-shopping-cart"></i>Pengembalian</a></div>
  </div>
<!--End-breadcrumbs-->
