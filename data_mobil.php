...
<!--Header-part-->
<div id="header">
  <h1><a href="data_mobil.php">Data Mobil</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="data_mobil.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Data Mobil</span></a>
  ...
  ?>
    ...
    <li class="active"> <a href="data_mobil.php"><i class="icon icon-tasks"></i> <span>Data Mobil</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="data_mobil.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> Data Mobil</a></div>
  </div>
<!--End-breadcrumbs-->
