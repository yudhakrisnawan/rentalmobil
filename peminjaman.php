...
<!--Header-part-->
<div id="header">
  <h1><a href="peminjaman.php">Peminjaman</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="entri_order.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Entri Order</span></a>
  ...
  ?>
    ...
    <li class="active"> <a href="peminjaman.php"><i class="icon icon-shopping-cart"></i> <span>Peminjaman</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="peminjaman.php" title="Go to here" class="tip-bottom"><i class="icon icon-shopping-cart"></i>Peminjaman</a></div>
  </div>
<!--End-breadcrumbs-->
