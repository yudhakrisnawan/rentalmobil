...
<!--Header-part-->
<div id="header">
  <h1><a href="pembayaran.php">Pembayaran</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="pembayaran.php" class="visible-phone"><i class="icon icon-inbox"></i> <span>pembayaran</span></a>
  <ul>
  <?php
    if($r['id_level'] == 1){
  ?>
    ...
    <li class="active"> <a href="pembayaran.php"><i class="icon icon-print"></i> <span>Pembayaran</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="pembayaran.php" title="Go to here" class="tip-bottom"><i class="icon icon-print"></i>Pembayaran</a></div>
  </div>
<!--End-breadcrumbs-->
